...
object KeyguardIndicationAreaBinder {
    ...
    fun bind(
        ...
        val previousTop = indicationController.IndicationAreaTop
        indicationController.indicationArea = view
        indicationController.indicationAreaTop = view
        disposables += DisposableHandle {
            previous?.let { indicationController.indicationArea = it }
            previousTop?.let {indicationController.indicationAreaTop = it }
        }
