   ...
   /**
    ...
    private void onSecureSettingsChangedLocked(@NonNull String key, @UserIdInt int userId) {
        switch (key) {
            ...
            case Settings.Secure.FEATURE_TOUCH_HOVERING:
                updateTouchHovering();
                break;
    ...
    @GuardedBy("ImfLock.class")
    private void onSystemSettingsChangedLocked(@NonNull String key, @UserIdInt int userId) {
        switch (key) {
            case Settings.System.HIGH_TOUCH_POLLING_RATE_ENABLE:
                updateTouchPollingRate();
                break;
            case Settings.System.HIGH_TOUCH_SENSITIVITY_ENABLE:
    ...
    public void systemRunning() {
        ...
        synchronized (ImfLock.class) {
            ...
            if (!mSystemReady) {
                ...
                // Must happen before onSecureSettingsChangedLocked or onSystemSettingsChangedLocked
                ...
                SystemSettingsChangeCallback.register(mHandler, mContext.getContentResolver(),
                        new String[] {
                                Settings.System.HIGH_TOUCH_POLLING_RATE_ENABLE,
                                Settings.System.HIGH_TOUCH_SENSITIVITY_ENABLE,
                        }, (key, flags, userId) -> {
                            synchronized (ImfLock.class) {
                                onSystemSettingsChangedLocked(key, userId);
                            }
                        });
